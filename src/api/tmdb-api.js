...
//   return fetch(
//     `https://api.themoviedb.org/3/discover/movie?api_key=${process.env.REACT_APP_TMDB_KEY}&language=en-US&include_adult=false&include_video=true&page=${p}`
//   ).then((response) => {
//     if (!response.ok) {
...
export const getMovies = (p) => {
  return fetch(
    `https://api.themoviedb.org/3/discover/movie?api_key=${process.env.REACT_APP_TMDB_KEY}&language=en-US&include_adult=false&page=${p}`
  )
    .then(res => res.json())
...
export const getTrendingShows = (p) => {
  ...
  export const getMovieReviews = (id) => {
    return fetch(
      ...
      .then((res) => res.json())
      .then((json) => {
        // console.log("JSON REVIES",json.results);
        return json.results;
      });
  };
  ...
  //     .then((res) => res.json())
  //     .then((json) => {
  //        console.log("JJJJSONNN",json.results);
  //       return json.results;
  //     });
  // };
